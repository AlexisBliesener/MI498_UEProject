...
#include "SetSwingSpeedTask.generated.h"

/**
 * StateTree instance data for the SetSwingSpeedTask task.
 */
USTRUCT(BlueprintType, meta = (DisplayName = "SetSwingSpeedTask"))
struct FSetSwingSpeedTaskInstanceData
{
	GENERATED_BODY()
	 ...
	 * New swing speed
	 */
	UPROPERTY(EditAnywhere,BlueprintReadOnly, Category = Input, meta = (Context, AllowDerivedTypes="true"))
	float NewSwingSpeed;
};
...
struct MI498_UEPROJECT_API FSetSwingSpeedTask : public FStateTreeTaskCommonBase
{
public:
	GENERATED_BODY()
	using FInstanceDataType = FSetSwingSpeedTaskInstanceData;
